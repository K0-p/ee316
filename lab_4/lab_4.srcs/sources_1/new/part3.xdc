...
##7 segment display
set_property PACKAGE_PIN W7 [get_ports {sseg6}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sseg6}]
set_property PACKAGE_PIN W6 [get_ports {sseg5}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sseg5}]
set_property PACKAGE_PIN U8 [get_ports {sseg4}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sseg4}]
set_property PACKAGE_PIN V8 [get_ports {sseg3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sseg3}]
set_property PACKAGE_PIN U5 [get_ports {sseg2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sseg2}]
set_property PACKAGE_PIN V5 [get_ports {sseg1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sseg1}]
set_property PACKAGE_PIN U7 [get_ports {sseg0}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sseg0}]